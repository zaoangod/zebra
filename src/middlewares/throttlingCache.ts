...
export type ThrottlingCacheSkipFunction = (url: string, opts: WretchOption) => boolean
export type ThrottlingCacheKeyFunction = (url: string, opts: WretchOption) => string
export type ThrottlingCacheClearFunction = (url: string, opts: WretchOption) => boolean
export type ThrottlingCacheInvalidateFunction = (url: string, opts: WretchOption) => string | RegExp | void
export type ThrottlingCacheConditionFunction = (response: WretchOption) => boolean
