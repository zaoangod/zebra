...
import type {Wretch, WretchError as WretchErrorType, WretchResponse, WretchResponseChain} from './type'
import {CATCHER_FALLBACK, FETCH_ERROR} from './constant'

/** 当获取响应不是 'ok' 时, 将抛出从 Error 继承的该类, 它扩展了 Error 字段, 并添加了状态, 文本和正文字段. */
