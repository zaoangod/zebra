...
export interface Wretch<Self = unknown, Chain = unknown, Resolver = undefined, ErrorType = undefined> {
    ...
    /** @private @internal */
    _catcher: Map<number | string | symbol, (error: ErrorType extends undefined ? WretchError : ErrorType, originalRequest: Wretch<Self, Chain, Resolver, ErrorType>) => void>
    /** @private @internal */
    _resolver: ((resolver: Resolver extends undefined ? Chain & WretchResponseChain<Self, Chain> : Resolver, originalRequest: Wretch<Self, Chain, Resolver, ErrorType>) => any)[]
    /** @private @internal */
    _defer: WretchDeferredCallback<Self, Chain, Resolver, ErrorType>[]
    /** @private @internal */
     ...
     */
    header(this: Self & Wretch<Self, Chain, Resolver, ErrorType>, headerValues: HeadersInit): this
     ...
     */
    content(this: Self & Wretch<Self, Chain, Resolver, ErrorType>, contentType: string): this
     ...
     */
    authorization(this: Self & Wretch<Self, Chain, Resolver, ErrorType>, authorization: string): this
     ...
     * const middleware = delay => next => (url, opts) => {
     ...
     * @category Helpers
     */
    middleware(this: Self & Wretch<Self, Chain, Resolver, ErrorType>, middlewares: ConfiguredMiddleware[], clear?: boolean): this
     ...
     *
     * @category Body Types
     * @param value - An object which will be serialized into a JSON
     */
     ...
     * @category Helpers
     */
    toFetch(this: Self & Wretch<Self, Chain, Resolver, ErrorType>): (url: string, options?: WretchOption) => Promise<Response>
}
...
export interface WretchResponseChain<T, Self = unknown, R = undefined, ErrorType = undefined> {
     ...
     *
     * ```js
     * wretch("...").get().response((response) => console.log(response.url));
     * ```
     * @category Response Type
     */
    response: <Result = WretchResponse>(cb?: (type: WretchResponse) => Promise<Result> | Result) => Promise<Awaited<Result>>,
    /**
 ...
 */
export type WretchOption = Record<string, any> & RequestInit
/**
 ...
 */
export type FetchLike = (url: string, opts: WretchOption) => Promise<WretchResponse>
 ...
 */
export type WretchDeferredCallback<T, C, R, E> = (wretch: T & Wretch<T, C, R, E>, url: string, options: WretchOption) => Wretch<T, C, any, E>
...
export type WretchAddon<W, R = unknown> = {
    beforeRequest?<T, C, R, E = unknown>(wretch: T & Wretch<T, C, R, E>, option: WretchOption, state: Record<any, any>): T & Wretch<T, C, R, E>,
    wretch?: W,
